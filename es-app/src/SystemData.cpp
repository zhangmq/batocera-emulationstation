...
#else
	std::string emulator = getShOutput(R"(/home/odroid/.config/emuelec/scripts/emuelec-utils setemu get ')" + getName() + ".emulator' ");
#endif
#endif
...
#else
	std::string core = getShOutput(R"(/home/odroid/.config/emuelec/scripts/emuelec-utils setemu get ')" + getName() + ".core' ");
#endif
#endif
